...
const checkNumbers = (apostado, sorteado) => {
...
const resultadoSorteio = (numApostado, checkFunction) => {
  const numSorteado = randomNumber();
  return checkNumbers(numApostado, numSorteado);
}

console.log(resultadoSorteio(10, checkNumbers))
